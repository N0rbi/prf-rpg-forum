...
@NgModule({
  declarations: [MainPageComponent, HeaderComponent, UserDetailsComponent, CharacterCreatorComponent, GameCreatorComponent],
  imports: [CommonModule, MaterialModule],
  providers: [],
  exports: [MainPageComponent],
  entryComponents: [GameCreatorComponent]
})
